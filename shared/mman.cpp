...
void* mmap(void* addr, size_t len, int prot, int flags, int fildes, off_t off)
{
    ...
    const DWORD dwFileOffsetLow = LOWORD(off);
    const DWORD dwFileOffsetHigh = HIWORD(off);
    ...
    const DWORD dwMaxSizeLow = LOWORD(maxSize);
    const DWORD dwMaxSizeHigh = HIWORD(maxSize);
