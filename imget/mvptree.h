...
/* Data type for a datapoint - refers to the width (in bytes) of each element */
...
typedef struct mvptree_t {
    ...
    int fd;                         /* internal use (file descriptor)                          */
    unsigned int k;                 /* internal use for retrieve function (k nearest)          */
    MVPDataType datatype;           /* internal use (byte-width of data)                       */
 ...
 *   ARGUMENTS:
 *
 *   tree - pointer to MVPTree to initialize (NULL to allocate one on the heap
 *
 ...
 *   RETURN:
 *
 *   MVPTree* pointer, NULL for error
 *
*/
 ...
 *  ARGUMENTS:
 *
 *  tree - pointer to tree to clear out
 *
 *  free_func - pointer to function to free the datapoint's id and data fields
 *
 *  RETURN
 *
 *  void
 ...
 *   ARGUMENTS:
 *
 *   tree - pointer to MVPTree a previously allocated tree.
 *
 ...
 *   DESCRIPTION:
 *
 *   retrieve k-nearest neighbors from the tree
 *
 *   ARGUMENTS:
 *
 *   tree - pointer to the MVPTree
 *
 ...
 *
 *   nbresults - pointer to int to contain the number of results returned to user.
 *
 *   error - pointer to error value to return error to user
 *
 *   RETURN:
 *
 ...
 *   ARGUMENTS:
 *
 *   tree - pointer to MVPTree struct
 *
 ...
 *   RETURN
 *
 *   MVPTree pointer, or NULL on error (and error is set to error code)
 *
 */
 ...
 *
 *   tree   - pointer to the MVPTree struct to print.
 *
 *   RETURN:
 *
 *   MVPERror code
